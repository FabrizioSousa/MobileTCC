...
namespace PrimeiraVersao.Services
{
    public class Predicao
    {
        ...
        public async Task<bool> Post(Usuario usuario)
        {
            ...
            //{
            //    var storageAccount = CloudStorageAccount.Parse("DefaultEndpointsProtocol=https;AccountName=tccinadimplanecia;AccountKey=kNEa4mJH9VYGlHa/PXcpl+rDBBLCwx/i3DI2AA/WpYFEP/sMvGMCBbyRXqwd2OomBTPZiZnE7u/CrKJ96EwyBQ==;EndpointSuffix=core.windows.net");
